...
//middleware for error handling because without this , error is shown in html and not in the json object
//this middleware is available in multer package
//for single file upload
const single = (fieldName) => {
  return function (req, res, next) {
    const uploadItem = uploads.single(fieldName);
...
//for multiple file upload-array
const multipleAraay = (fieldName, max) => {
  return function (req, res, next) {
    const uploadItems = uploads.array(fieldName, max);
...
//for multiple file upload-any
const multipleAny = (fieldName) => {
  return function (req, res, next) {
    const uploadItems = uploads.any(fieldName);
...
module.exports = { single, multipleAraay,multipleAny };
